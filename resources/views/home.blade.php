                ...
                <div class="category-menu-list">
                    <ul>
                        @foreach ($categories as $category)
                            <li>
                            <a href="{{route('products.index', ['category_id' => $category->id])}}"><img alt="" src="assets/img/icon-img/7.png">{{ $category->name }}<i
                                    ...
                                    <div class="category-menu-dropdown">
                                        @foreach ($children as $child)
                                            <div class="category-dropdown-style category-common3">
                                                ...
                                                @php
                                                $grancChild = TCG\Voyager\Models\Category::where('parent_id',
                                                $child->id)->get();
                                                @endphp

                                                @if ($grancChild->isNotEmpty())
                                                    <ul>
                                                        @foreach ($grancChild as $mini)
                                                            <li><a href="{{ route('products.index', ['category_id' => $mini->id]) }}"> {{ $mini->name }} </a>
                                                            </li>
                                                        @endforeach
                                                    </ul>
                                                @endif
